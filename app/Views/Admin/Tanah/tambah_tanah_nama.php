            ...
            <div class="letter">
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" disabled value="<?= $nama ?>" class="form-control" id="NAMANOP">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" disabled value="<?= $bin ?>" class="form-control" id="bin">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" value="<?= $no_buku ?>" disabled class="form-control" id="nobuku">
                        <input type="hidden" name="no_buku_c" value="<?= $no_buku ?>">
                        <div class="invalid-feedback">
